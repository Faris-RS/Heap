function createMinHeap() {
  ...
  function heapifyDown() {
    ...
    while (hasLeftChild(index)) {
      ...
      if (
        getNodeByIndex(index).value < getNodeByIndex(smallerChildIndex).value
      ) {
        break;
      } else {
        const currentNode = getNodeByIndex(index);
        const smallerChildNode = getNodeByIndex(smallerChildIndex);
        swapNodes(currentNode, smallerChildNode);
      }
